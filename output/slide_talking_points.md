...
- Open with the headline: Discount Division delivered $25.4B in 2020 sales and grew 6.8%.
- Immediately contrast that with industry growth of 11.0%; this is why growth alone is not enough to call the year a win.
- Point out the national share decline from 18.0% to 17.3%, or -0.7 pts.
...
- Walk through the sales-growth comparison: Discount Division at 6.8% versus industry at 11.0%.
- Note that promo penetration was 35.2%, matching the national industry, and down from 36.1% in 2019.
- Explain implication: the answer should not simply be "promote more"; it should be more targeted value and promo discipline.
- Highlight e-commerce: division e-commerce sales grew 207% and reached 4.6% penetration, but industry was 5.0%.
...
- Start with the regional table: Ontario sales grew only 2.9%, and share declined -1.0 pts.
...
- Call out banner-level split: No Frills Ontario grew 6.3%, while RCSS Ontario declined -9.6%.
